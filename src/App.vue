                ...
                passability: [
                    {
                        ...
                        descr: "MET Allroad создавалось для использования в городе, не всегда адаптированном для передвижения человека на кресле-коляски. Для того, чтобы пользователь мог преодолевать больший угол пандуса или не повис на амортизаторах, оставшийся без движения, при съезде с бордюра, мы оснастили коляску динамическим антиопрокидывателем. Он представляют собой подвижный рычаг с роликом, установленный на раму через амортизатор. В момент упора амортизатор кратковременно прожимается, давая большую геометрическую проходимость, после чего возвращается в исходное положение, надежно защищая от переворота коляски. Таким образом, с креслом-коляской Вам доступно то, что недоступно пользователям других колясок.",
                    },
                    {
                        img: "2159.jpg",
                        title: "Мощные моторы",
                        descr: "Мощные моторы позволяют преодолевать угол наклона до 15 градусов без разгона, а также развивать скорость до 13 км/час. Технически кресло-коляска создано таким образом, чтобы не происходила потеря мощности на дорогах любого качества:  на рыхлом грунте, при преодолении бордюров или возможных препятствий, въезде на пандус и т.д. Мощность коляски обеспечивают два независимых мотора - по 500 Ватт каждый. Массивные редукторы, передающие крутящий момент на колеса, рассчитаны на высокую нагрузку. Они не греются даже при длительном использовании коляски на максимальной скорости или длительном заезде в гору. Питается коляска от современного 55 АH тягового аккумулятора в защищенном толстостенном стальном кофре.",
                    },
                    {
                        img: "2173.jpg",
